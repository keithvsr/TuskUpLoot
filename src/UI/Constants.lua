...
UI.Constants = {
  ...
  EXPORT_EDIT_HEIGHT = 100,
  EXPORT_RAID_LIST_HEIGHT = 168,
  EXPORT_SR_IMPORT_FRAME_WIDTH = 480,
  EXPORT_SR_IMPORT_FRAME_HEIGHT = 320,
  EXPORT_SR_IMPORT_EDIT_WIDTH = 440,
  EXPORT_SR_IMPORT_EDIT_HEIGHT = 180,
